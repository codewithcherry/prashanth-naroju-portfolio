...
export default function Home() {
  return (
    <div
      ...
      className="relative bg-white dark:bg-black min-h-screen p-8 flex flex-col items-center justify-center"
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <p className="text-black dark:text-white">
          Toggle the button to switch between light and dark mode.
        </p>
        <DarkModeToggle />
      </div>
